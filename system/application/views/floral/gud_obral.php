...
<div id="templatemo_content_area_bottom">   
    <div class="templatemo_right_section">
        <div class="tempatemo_section_box_1">
            <h1>Laporan >> Cetak Barang Obral</h1>
            <?php echo form_open('gudang/obral') ?>            
            <table class="table-form">                              
                <tr>
                    <td>Nama Toko</td>
                    <td>: <?php echo $list_toko_obral ?>
                        <span class="button"><input type="submit" name="submit_preview_obral" value="Preview" class="button"/></span>
                    </td></tr>                
            </table>            
            <?php echo form_close() ?>
            ...
            <p style="text-align:center;font-weight:bold;color:#000;">BON BARANG OBRAL</p>
            <table class="table-form">                               
            ...
            <a href="<?php echo base_url().'gudang/obral/'.$dist_code.'/'.$shop->shop_code ?>" target="new">
                <span class="button"><input class="button" type="submit" name="submit_cetak_obral" value="Cetak"></span>
            </a>
            </p>
            <!--<?php echo form_close() ?>-->
            </div>            
