...
<div id="templatemo_content_area_bottom">   
    <div class="templatemo_right_section">
        <div class="tempatemo_section_box_1">
            ...
            <table class="table-form">
            <tr><td>Kode Bon</td><td> : <?php echo $dist_code[$i] ?></td></tr>
                            <tr><td>Toko Tujuan</td><td> : <?php echo $shop->shop_name ?></td></tr>
                            <tr><td>Tanggal</td><td> : <?php echo date_to_string($tgl_bon[$i]) ?></td></tr>
                        </table>
                        ...
                        <!--<?php echo form_open('gudang/cetak/bon') ?>-->
                        <p style="text-align:center"><input type="hidden" name="dist_code" value="<?php echo $dist_code[$i] ?>"/>
                        <a href="<?php echo base_url().'gudang/cetak/bon/'.$dist_code[$i].'/'.$shop->shop_code.'/'.$tgl_bon[$i] ?>" target="new">
