...
<div id="templatemo_content_area_bottom">   
    <div class="templatemo_right_section">
        <div class="tempatemo_section_box_1">
            <h1>Laporan >> Rekap Bon Obral</h1>
            <?php echo form_open('gudang/obral/rekap') ?>            
            <table class="table-form">                              
                <tr>
                    <td>Nama Toko</td>
                    <td>: <?php echo $list_toko_obral_pdf ?>                        
                    </td></tr>
                <tr><td>Tanggal</td><td> : <input type="text" id="date_bon" name="date_bon" value="" readonly="readonly" style="width:120px"/>
                <span class="button"><input type="submit" name="submit_rekap_obral" value="Display" class="button"/></span>
                </td></tr>      
            </table>            
            <?php echo form_close() ?>
            ...
            <p style="text-align:center;font-weight:bold;color:#000;">DAFTAR BON BARANG OBRAL</p>
            <table class="table-form">                       
